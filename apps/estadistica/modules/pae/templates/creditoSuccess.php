...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="/assets/css/themes/light2.css" rel="stylesheet" type="text/css" id="style_color"/>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-money"></i>
                                <a href="javascript:;">Casa de Créditos Future–Credit</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Casa de Créditos Future–Credit</h3>
                            <hr/>
                            <div class="col-md-6">
                                <img src="/images/New World/future.jpg" style="width:100%"/>
                            </div>
                            <div class="col-md-5">
                                <br/>
                                <span>
                                    <font size="3">
                                    <p align="justify">
                                       Future Credit nació de la idea de cuatro socios llamados: Josué Urizar, Pablo Santizo, Celeste López y Mishel López.
Ellos querían hacer una empresa de créditos donde sus tasas de intereses no fueran tan elevadas para las personas y que ellos se sientan tranquilos al saber que les brindamos total seguridad y confianza.
                                    </p>
                                    </font>
                                </span>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <font size="3">
                                <p align="justify">
                                    Nos comprometemos de lleno para poder trabajar como las personas lo esperan, siempre brindándoles un buen servicio y que ellos queden conformes con nuestra labor.
                                </p>
                                </font>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <font size="3">
                                <p align="justify">
                                    Ser reconocidos internacionalmente por trabajar con calidad total y un gran compromiso. Ser la empresa #1 de créditos donde la gente nos prefiera por aquello que solo nosotros le ofrecemos.
                                </p>
                                </font>
                            </div>
                        ...
                        <div class="col-md-12">
                            <h3><i class="fa fa-print"></i> Razón Social</h3>
                            <hr/>
                            <div class="col-md-8">
                                <font size="5">
                                <p align="justify">
                                    “Créditos del Futuro, S.A”
                                </p>
                                </font>
                            </div>
