            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <img src="/images/New World/logo.png" style="width:100%"/>
                            </div>
                            <div class="col-md-5">
                                <br/>
                                <span>
                                    <font size="3">
                                    <p align="justify">
                                        Corporación “New World” es una institución conformada por 4 empresas las cuales su fin primordial es ir un paso delante de la gente velando por el bienestar de la misma, brindándoles diferentes opciones para la mejora de la calidad de vida del hoy y del mañana.
                                        <br/>
                                        <br/>
                                        New World en español significa “Nuevo Mundo” con esto queremos dar a conocer que trabajando en conjunto estas 4 empresas podemos crear un nuevo mundo donde sus bases son inclinarse por las nuevas tendencias tecnológicas aplicando simultáneamente técnicas de reciclaje mas objetivas y convenientes.
                                    </p>
                                    </font>
                                </span>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="dashboard-stat blue-madison">
                                                    ...
                                                    <a class="more" href="<?php echo url_for('pae/iberoamericano')?>">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="dashboard-stat red-intense">
                                                    ...
                                                    <a class="more" href="<?php echo url_for('pae/credito')?>">
                                                        Ver Más <i class="m-icon-swapright m-icon-white"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="dashboard-stat green-haze">
                                                    ...
                                                    <a class="more" href="<?php echo url_for('pae/paseo')?>">
                                                        Ver Más <i class="m-icon-swapright m-icon-white"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="dashboard-stat purple-plum">
                                                    ...
                                                    <a class="more" href="<?php echo url_for('pae/residencial')?>">
                                                        Ver Más <i class="m-icon-swapright m-icon-white"></i>
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <font size="3">
                                <p align="justify">
                                    Somos una institución que se centra principalmente en el bienestar de las personas y fomentar en ellas la ideología de pensar en el futuro de sí mismo o su familia, creando conciencia sobre el reciclaje y los grandes beneficios que nos trae el ver más allá.
                                </p>
                                </font>
                            </div>
