                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-home"></i>
                                <a href="javascript:;">Residenciales Futu-Live</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div class="row">
                        ...
                        <br/><br/>
                        <div class="col-md-6">
                            <h3><i class="fa fa-shield"></i> Residencial</h3>
                            <hr/>
                            <font size="3">
                            Nuestro residencial cuenta principalmente por las casas y apartamentos asi como también de otro diferentes lugares que ayudaran a la comodidad, seguridad y bienestar de las personas. 
                            </font>
                            <img style="width:100%"  src="/images/New World/residencial.jpg"/>
                        </div>
                        <div class="col-md-6">
                            <h3><i class="fa fa-home"></i> Casas</h3>
                            <hr/>
                            <font size="3">
                            Contamos con dos diseños realmente muy atractivos y con diferentes beneficios asi como también con un diseño interno pensado en la comodidad de las familias.
                            </font>
                            <img style="width:100%"  src="/images/New World/casa.png"/>
                        </div>
                        <div class="col-md-6">
                            <h3><i class="fa fa-building-o"></i> Torres</h3>
                            <hr/>
                            <font size="3">
                            Contamos con dos torres exclusivamente de apartamentos diseñados especialmente para aquellas personas que deseen estar en un lugar confortable y único.
                            </font>
                            <img style="width:100%" src="/images/New World/torre.jpg"/>
                        </div>
                        <div class="col-md-6">
                            <h3><i class="fa fa-child"></i> Parque</h3>
                            <hr/>
                            <font size="3">
                            Es un sitio donde todas las personas que vivien dentro del residencial pueden ir a dar un paseo y cuenta con área para picnic, juegos para niños y diversidad de fauna y flora promoviendo su cuidado y preservación.
                            </font>
                            <img style="width:100%"  src="/images/New World/parque.png"/>
                        </div>
                        <div class="col-md-6">
                            <h3><i class="fa fa-trophy"></i> Polideportivo</h3>
                            <hr/>
                            <div class="col-md-4">
                                <img style="width:100%"  src="/images/New World/poli.png"/>
                            </div>
                            <div class="col-md-8">
