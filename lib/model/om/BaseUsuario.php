...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->administrador = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
            ...
            return $startcol + 10; // 10 = UsuarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setAdministrador($arr[$keys[5]]);
